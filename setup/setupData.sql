...
INSERT INTO Books (BookName, Author , CategoryID, Quantity) VALUES
    ('Lập trình Python','Đoàn Minh Phụng', 4, 15),
    ('Thơ ca Việt Nam','Bùi Minh Nguyên_ Hà Minh Đức', 1, 20),
    ('Lịch sử thế giới','Jane Chisholm', 3, 10),
    ('Kinh tế vi mô','Lê Bảo Lâm', 5, 12),
    ('Tâm lý học hành vi','', 6, 18),
    ('Nghệ thuật tranh sơn dầu','Nguyễn Đình Đăng', 8, 8),
    ('Giáo dục hiện đại','Hồ Ngọc Đại', 10, 25),
    ('Toán học cơ bản và nâng cao','Nguyễn Đức Tán_Tại Hồ Thị Dung', 2, 22),
    ('Lịch sử Việt Nam','Đào Duy Anh', 3, 13),
    ('Giáo trình huấn luyện sức mạnh','Bùi Trọng Toại', 10, 11),
    ('Học tiếng Anh cơ bản','Elight' 10, 30),
    ('Thơ Hàn Mặc Tử','Hàn Mạc Tử', 1, 17),
    ('Y học cổ truyền','Đặng Minh Hằng_Nguyễn Thị Thu Hà', 9, 5),
    ('Chuyên đề văn học','Nguyễn Thành Huân' 1, 21),
    ('Trái đất và vũ trụ','Science Encyclopedia', 2, 18),
    ('Nhạc cổ điển','Stacy', 10, 7),
    ('Công nghệ blockchain','William', 4, 9),
    ('Tâm lý trẻ em','Nguyễn Khắc Viện', 6, 16),
    ('Nghệ thuật sân khấu','Trần Văn Khải', 10, 10),
    ('Văn học dân gian',' Đinh Gia Khánh', 1, 23),
    ('Thế giới động vật','Science Encyclopedia', 2, 14),
    ('Du lịch Việt Nam','Bùi Thị Hải Yến', 10, 8),
    ('Học tiếng Pháp','Trần Sỹ Lan_Hoàng Lê Chính',10, 12),
    ('Kinh tế toàn cầu','Nguyễn Xuân Thắng', 5, 15),
    ('Vật lý cơ bản','Hoàng Ngọc Long', 2, 19),
    ('Kỹ thuật lập trình','Phạm Văn Ất', 4, 22),
    ('Thơ hiện đại','Lã Nguyên', 1, 10),
    ('Triết học phương Tây','Bernard Morichrer', 7, 9),
    ('Y học hiện đại','Trần Đức Phấn_ Lương Thị Lan Anh' 9, 11),
    ('Văn học phương Tây','Lê Nguyên Cẩn', 1, 13);
